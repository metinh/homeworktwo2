...
```{r}
ranking <- c(4, 2, 5, 1, 3)
wizards <- c(Harry=4, Ron=2, Hermione=5, Ginny=1, Malfoy=3)
wizards
```
...
```{r}
wizards <- replace(ranking, c(1, 2, 3, 4, 5), c("Lead", "Friend", "Friend", "Wife", "Rival"))
wizards
```
